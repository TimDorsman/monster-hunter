...
export function hasClaimedReward(progress: PlayerProgress, rewardId: string) {
	return progress.claimedRewardIds.includes(rewardId);
}

export function getBattleRewardClaimStatus(
...
export function sellAllInventory(progress: PlayerProgress) {
